...
///
/// Compare to the `mascot` demonstration to see the rendering without the extra effects: the standard
/// mascot is flat shaded, and the extra shading programatically added here adds a lot of depth to the
/// image.
///
/// This example demonstrates a lot of the power, flexibility and conciseness of the rendering approach
/// provided by `flo_canvas` and `flo_draw`. Many vector libraries have drop shadows as binary effects
/// but all the effects here are performed as full vector operations.
///
