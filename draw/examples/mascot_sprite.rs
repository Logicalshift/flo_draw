...
///
/// Sprites cache their rendering instructions on the GPU so they render more quickly. They're also a way to quickly repeat a
/// set of rendering instructions and can be used to display filter effects or generate textures to apply to other effects.
///
pub fn main() {
    with_2d_graphics(|| {
        // Decode
