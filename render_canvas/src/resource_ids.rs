...
pub (crate) const OFFSCREEN_RENDER_TARGET: RenderTargetId   = RenderTargetId(2);
pub (crate) const RESOLVE_RENDER_TARGET: RenderTargetId     = RenderTargetId(3);
...
pub (crate) const OFFSCREEN_TEXTURE: TextureId              = TextureId(3);
