    ...
    fn texture_render_request(&self, request: &TextureRenderRequest) -> Vec<render::RenderAction> {
        ...
        match request {
            ...
            DynamicTexture(texture_id, layer_handle, bounds, size, transform, post_rendering) => {
                ...
                render_actions.push(render::RenderAction::FilterTexture(*texture_id, vec![render::TextureFilter::GaussianBlurHorizontal(20.0, 121), render::TextureFilter::GaussianBlurVertical(20.0, 121)]));
