...
fn clip_rect() {
    ...
    executor::block_on(async {
        ...
        assert!(match rendering[8] { UseShader(render::ShaderType::Simple { clip_texture: None, erase_texture: None }) => true, _ => false });
        ...
        assert!(match rendering[15] { UseShader(render::ShaderType::Simple { clip_texture: Some(render::TextureId(1)), erase_texture: None }) => true, _ => false });
