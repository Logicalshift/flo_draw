...
fn lower_edges_7() {
    ...
    for offset in 0..100 {
        ...
        assert!(upper1.max(lower1) >= 500.0 && upper1.min(lower1) <= 500.0, "{}..{} ({})", lower1, upper1, height);
        */
...
#[test]
fn clipping_path_without_clipping_1() {
    use Draw::*;
    use PathOp::*;
...
#[test]
fn clipping_path_without_clipping_2() {
    use Draw::*;
    use PathOp::*;
