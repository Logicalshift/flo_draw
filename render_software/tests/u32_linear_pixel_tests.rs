...
#[test]
fn round_trip() {
    let col1            = U32LinearPixel::from_color(Color::Rgba(0.2, 0.3, 0.4, 0.5), 1.0);
    let back_as_color   = col1.to_color(1.0);

    let (r, g, b, a)    = back_as_color.to_rgba_components();

    debug_assert!((r-0.2).abs() < 0.025, "r({}, {}, {}, {})", r, g, b, a);
    debug_assert!((g-0.3).abs() < 0.025, "g({}, {}, {}, {})", r, g, b, a);
    debug_assert!((b-0.4).abs() < 0.025, "b({}, {}, {}, {})", r, g, b, a);
    debug_assert!((a-0.5).abs() < 0.01, "({}, {}, {}, {})", r, g, b, a);
}

#[test]
fn from_color() {
    let linear_pixel    = U32LinearPixel::from_color(Color::Rgba(0.1, 0.2, 0.3, 1.0), 2.2);
...
fn gamma_correction_2() {
    let linear_pixel    = U32LinearPixel::from_color(Color::Rgba(0.1, 0.2, 0.3, 1.0), 1.0);
    let back_as_color   = linear_pixel.to_color(2.2);
...
fn gamma_correction_3() {
    let linear_pixel    = U32LinearPixel::from_color(Color::Rgba(1.0, 1.0, 1.0, 0.5), 2.2);
    let back_as_color   = linear_pixel.to_color(1.0);
...
fn gamma_correction_4() {
    let linear_pixel    = U32LinearPixel::from_color(Color::Rgba(0.0, 0.0, 0.0, 0.25), 2.2);
    let back_as_color   = linear_pixel.to_color(1.0);
...
#[test]
fn add_1() {
    let col1 = U32LinearPixel::from_color(Color::Rgba(0.2, 0.3, 0.4, 1.0), 1.0);
    let col2 = U32LinearPixel::from_color(Color::Rgba(0.5, 0.5, 0.5, 1.0), 1.0);

    let col3            = col1 + col2 - U32LinearPixel::black();
    let back_as_color   = col3.to_color(1.0);

    let (r, g, b, a)    = back_as_color.to_rgba_components();

    println!("{:?} {:?} {:?}", col1, col2, col3);
    debug_assert!((r-0.7).abs() < 0.025, "r({}, {}, {}, {})", r, g, b, a);
    debug_assert!((g-0.8).abs() < 0.025, "g({}, {}, {}, {})", r, g, b, a);
    debug_assert!((b-0.9).abs() < 0.025, "b({}, {}, {}, {})", r, g, b, a);
}
...
fn multiply_1() {
    ...
    println!("{:?} {:?} {:?}", col1, col2, col3);
    debug_assert!((r-0.1).abs() < 0.025, "r({}, {}, {}, {})", r, g, b, a);
    debug_assert!((g-0.2).abs() < 0.025, "g({}, {}, {}, {})", r, g, b, a);
    debug_assert!((b-0.3).abs() < 0.025, "b({}, {}, {}, {})", r, g, b, a);
...
fn source_over_2() {
    ...
    U32LinearPixel::to_gamma_colorspace(&col3, &mut back_as_color, 2.2);
