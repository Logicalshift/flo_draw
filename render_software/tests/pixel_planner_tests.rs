...
fn small_rectangle_on_rectangle() {
    ...
    assert!(pixel_plan[0].iter_as_spans().collect::<Vec<_>>() == vec![ScanSpan::opaque(100..200, program_data_id_1)], "[0, y == 139.0] {:?}", pixel_plan[1].iter_as_spans().collect::<Vec<_>>());
...
fn identical_overlapping_rectangles_1() {
    ...
    assert!(pixel_plan[1].iter_as_spans().collect::<Vec<_>>() == vec![ScanSpan::opaque(100..200, program_data_id_2)], "[1, y == 125.0] {:?}", pixel_plan[1].iter_as_spans().collect::<Vec<_>>());
    assert!(pixel_plan[2].iter_as_spans().collect::<Vec<_>>() == vec![ScanSpan::opaque(100..200, program_data_id_2)], "[2, y == 126.0] {:?}", pixel_plan[2].iter_as_spans().collect::<Vec<_>>());
}
...
fn identical_overlapping_rectangles_2() {
    ...
    assert!(pixel_plan[0].iter_as_spans().collect::<Vec<_>>() == vec![], "[0, y == 124.0] {:?}", pixel_plan[1].iter_as_spans().collect::<Vec<_>>());
    assert!(pixel_plan[1].iter_as_spans().collect::<Vec<_>>() == vec![ScanSpan::opaque(100..200, program_data_id_1)], "[1, y == 125.0] {:?}", pixel_plan[1].iter_as_spans().collect::<Vec<_>>());
    assert!(pixel_plan[2].iter_as_spans().collect::<Vec<_>>() == vec![ScanSpan::opaque(100..200, program_data_id_1)], "[2, y == 126.0] {:?}", pixel_plan[2].iter_as_spans().collect::<Vec<_>>());
}
...
fn identical_overlapping_rectangles_3() {
    ...
    assert!(pixel_plan[0].iter_as_spans().collect::<Vec<_>>() == vec![], "[0, y == 124.0] {:?}", pixel_plan[1].iter_as_spans().collect::<Vec<_>>());
    assert!(pixel_plan[1].iter_as_spans().collect::<Vec<_>>() == vec![ScanSpan::opaque(100..200, program_data_id_1), ScanSpan::transparent(100..200, program_data_id_2)], "[1, y == 125.0] {:?}", pixel_plan[1].iter_as_spans().collect::<Vec<_>>());
    assert!(pixel_plan[2].iter_as_spans().collect::<Vec<_>>() == vec![ScanSpan::opaque(100..200, program_data_id_1), ScanSpan::transparent(100..200, program_data_id_2)], "[2, y == 126.0] {:?}", pixel_plan[2].iter_as_spans().collect::<Vec<_>>());
}
...
fn clip_left() {
    ...
    assert!(pixel_plan[1].iter_as_spans().collect::<Vec<_>>() == vec![ScanSpan::opaque(0..200, program_data_id)], "[1, y == 125.0] {:?}", pixel_plan[1].iter_as_spans().collect::<Vec<_>>());
    assert!(pixel_plan[2].iter_as_spans().collect::<Vec<_>>() == vec![ScanSpan::opaque(0..200, program_data_id)], "[2, y == 126.0] {:?}", pixel_plan[1].iter_as_spans().collect::<Vec<_>>());
}
...
fn clip_right() {
    ...
    assert!(pixel_plan[1].iter_as_spans().collect::<Vec<_>>() == vec![ScanSpan::opaque(100..1000, program_data_id)], "[1, y == 125.0] {:?}", pixel_plan[1].iter_as_spans().collect::<Vec<_>>());
    assert!(pixel_plan[2].iter_as_spans().collect::<Vec<_>>() == vec![ScanSpan::opaque(100..1000, program_data_id)], "[2, y == 126.0] {:?}", pixel_plan[1].iter_as_spans().collect::<Vec<_>>());
}
...
fn clip_both() {
    ...
    assert!(pixel_plan[1].iter_as_spans().collect::<Vec<_>>() == vec![ScanSpan::opaque(0..1000, program_data_id)], "[1, y == 125.0] {:?}", pixel_plan[1].iter_as_spans().collect::<Vec<_>>());
    assert!(pixel_plan[2].iter_as_spans().collect::<Vec<_>>() == vec![ScanSpan::opaque(0..1000, program_data_id)], "[2, y == 126.0] {:?}", pixel_plan[1].iter_as_spans().collect::<Vec<_>>());
}
