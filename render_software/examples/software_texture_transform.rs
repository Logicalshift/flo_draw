...
fn draw_scaled_mascot(canvas: &mut impl GraphicsPrimitives, x: f32, y: f32, width: f32, height: f32, flo_w: f32, flo_h: f32) {
    canvas.new_path();
...
pub fn main() {
    ...
    draw_scaled_mascot(&mut canvas, 87.5 + 0.0, 0.0, 50.0, 50.0/ratio, flo_w as _, flo_h as _);
    draw_scaled_mascot(&mut canvas, 87.5 + 75.0, 0.0, 100.0, 100.0/ratio, flo_w as _, flo_h as _);
    draw_scaled_mascot(&mut canvas, 87.5 + 200.0, 0.0, 200.0, 200.0/ratio, flo_w as _, flo_h as _);
    draw_scaled_mascot(&mut canvas, 87.5 + 425.0, 0.0, 400.0, 400.0/ratio, flo_w as _, flo_h as _);
    draw_scaled_mascot(&mut canvas, 250.0, 500.0, 500.0, 500.0/ratio, flo_w as _, flo_h as _);
