...
pub enum ShaderType {
    ...
    Texture { texture: TextureId, texture_transform: Matrix, repeat: bool, alpha: f32, premultiply_colours: bool, clip_texture: Option<TextureId> },
...
impl ShaderType {
    ...
    pub fn with_clip_mask(self, new_clip_mask_texture: Option<TextureId>) -> ShaderType {
        ...
        match self {
            ...
            Texture { texture, texture_transform, repeat, alpha, premultiply_colours, clip_texture: _ } => Texture          { texture: texture, texture_transform: texture_transform, repeat, alpha, premultiply_colours, clip_texture: new_clip_mask_texture },
